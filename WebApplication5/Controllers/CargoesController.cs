...
namespace WebApplication5.Controllers
{
    public class CargoesController : Controller
    {
        ...
        public CargoesController(BienmesabeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCargo,Nombre,Salario")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCargo,Nombre,Salario")] Cargo cargo)
        {
            if (id != cargo.IdCargo)
            {
                return NotFound();
