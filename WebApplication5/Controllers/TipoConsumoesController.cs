...
namespace WebApplication5.Controllers
{
    public class TipoConsumoesController : Controller
    {
        ...
        public TipoConsumoesController(BienmesabeContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.TipoConsumos.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("IdTipoConsumo,Tipo")] TipoConsumo tipoConsumo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTipoConsumo,Tipo")] TipoConsumo tipoConsumo)
        {
        ...
        {
            return _context.TipoConsumos.Any(e => e.IdTipoConsumo == id);
        }
    }
}
